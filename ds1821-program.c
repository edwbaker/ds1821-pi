...
/*
 * ds1821-program.c — DS1821 direct GPIO bit-bang utility
 *
 ...
 *
 * Build:  gcc -Wall -o ds1821-program ds1821-program.c -lpigpio -lrt -lpthread
 * Run:    sudo ./ds1821-program [options]
 *
 * Must be run as root.
 */
